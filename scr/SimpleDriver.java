...
public class SimpleDriver extends Controller {
    ...
    public Action control(SensorModel sensors) {
        ...
        if (currentTime - lastTimeDidAction < DELTA_MILLIS) {
            ...
            Sample newSample = new Sample(angleToTrackAxis, trackPosition, trackEdgeSensor11, trackEdgeSensor10,
            trackEdgeSensor9, trackEdgeSensor8, trackEdgeSensor7, xSpeed, ySpeed);
    ...
    private void printToCSV(SensorModel sensors, int cls) {
        ...
        long currentTime = System.currentTimeMillis();
        String datasetPath = "../IA-In-Torcs/dataset.csv"; // path del file CSV in cui salviamo i dati
